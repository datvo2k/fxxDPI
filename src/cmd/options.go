...
type Options struct {
	...
	// BlockRules is a list of wildcards that define connections to which hosts will be blocked.
	...
	// DropRules is a list of wildcards that define connections to which hosts will be "dropped".  "Dropped" means that the connection will be delayed for a hard-coded period of 3 minutes.
